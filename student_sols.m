...
% directory as this file as well as any of the standard matlab functions.
    ...
    function symb = bits2qpsk(bits)
        ...
        symb = sqrt(1/2)*(bits(1:2:end) + 1i*bits(2:2:end)); %TODO: This line is missing some code!
    end
    ...
    function [rx, evm, ber, symbs] = sim_ofdm_known_channel(tx, h, N_cp, snr, sync_err)
        ...
        zcp = add_cyclic_prefix(z,Ncp); %TODO: This line is missing some code!
        ...
        y = remove_cyclic_prefix(ycp,Ncp); %TODO: This line is missing some code!
